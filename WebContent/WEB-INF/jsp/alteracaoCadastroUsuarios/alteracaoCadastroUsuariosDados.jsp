...
<script type='text/javascript' src='/safetycar/dwr/interface/alteraCadastroUsuariosAjaxDwr.js'></script>
	...
	function addItems() {
		...
		function frmSubmit() {
		  ...
		  var usuario = {
	 	  ...
	 	  alteraCadastroUsuariosAjaxDwr.altUsuarios(usuario, grupos, {
				callback : function(retorno) {
		 			...
		 			if(retorno[0] == 'ERRO'){
						...
						window.location="alteracaoCadastroUsuarios"; 	
					}
...
<div align="center">
	<font size="5" face="Times, serif" color="black"><b><i> Alteracao Cadastro de Usu&aacute;rio</i></b></font>	
</div>
		...
		<td colspan="2">
			<table border="0" cellpadding="3" cellspacing="1" align="center">	
				...
				<tr>
					...
					<td>
						<input id="login" name="login" type="text" style="width:200px; height: 24px;" maxlength="31" onkeyup="formataTexto(this); converteMinuscula(this);" value="${usuario.login }">&nbsp;
					</td>		
				</tr>
		...
		<td colspan="2">			
			...
			<div style="width: 400px; float: left">
				...
				<select style="width: 390px; height: 180px;" id=availableItems multiple name=availableItems>				
				 	<c:forEach items="${gruposDisponiveis}" var="grupo">				 		
				 		<option id="${grupo.id}" value="${grupo.id}"> ${grupo.nome } </option>				 							 	
				 	</c:forEach>					 
				</select> 
			</div>
			...
			<div style="width: 400px; float: left">
				...
				<select style="width: 390px; height: 180px;" id=selectedItems multiple size=10 name=selectedItems>
					<c:forEach items="${gruposLiberados}" var="grupo">				 		
				 		<option id="${grupo.id}" value="${grupo.id}"> ${grupo.nome } </option>				 							 	
				 	</c:forEach>
				</select> 
			</div>			
