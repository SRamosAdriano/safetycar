...
<script type="text/javascript">
	function removeVeiculo(idVeiculo, tipo){
		...
		if(tipo == 'mensagem'){
			...
			window.location="alteracaoVendaVeiculoExcluirVeiculo?idVeiculo=" + document.getElementById("idVeiculo").value;
		}		
	}
</script>
...
<div align="center">
	<font size="4" face="Times, serif" color="black"><i>Pesquisa Veiculo Vendido</i></font>
</div>
	...
	<td colspan="4"> 
		<t:paginacao id="tabela_AltCF" lista="${itensRelatorio}" semPaginacao="false">
			...
			<jsp:attribute name="linha">	
				...
				<td align="center">
					<a href="alteracaoVendaVeiculoSelecionadoVeiculo?id=${item.id}">
				...
				<td colspan="4" align="right">					 
					<a href="#dialog1" name="modal" style="text-decoration:none" onclick="$('html, body').animate({ scrollTop: 0 }, 'slow'); removeVeiculo(${item.id}, 'mensagem');" >
						<img src="/safetycar/resources/imagens/remove01.png" width="20" height="20" border="0" title="Excluir Venda" alt="Excluir Venda"
				...
				<tr>
					...
					<td> 
						<font size='4' face='Times, serif' color='black'>
							Tem certeza que deseja disponibilizar o veiculo para venda?
						</font>
					</td>
				</tr>
			</table>
