...
<script type='text/javascript' src='/safetycar/dwr/interface/cadastroFornecedorDespesasAjaxDwr.js'></script>
...
<script type="text/javascript">
	function adicionar(){
		...
		cadastroFornecedorDespesasAjaxDwr.addFornecedorDespesas(fornecedorDespesas, dtCadastro, {
...
<div align="center">
	<font size="5" face="Times, serif" color="black"><b><i>Cadastro Fornecedor Despesas</i></b></font>	
</div>
...
<table width="98%" border="0" cellpadding="1" cellspacing="0" align="center">		
	...
	<table border="0" cellpadding="3" cellspacing="1" align="center" >
		...
		<tr>
			...
			<td>
				<input id="dtCadastro" name="dtCadastro" type="text" style="width:200px; height: 24px;" maxlength="10" onblur="validaData(this)" onKeyUp="bloqueiaData(this);return mascara(this, '##/##/####', event);"
					value="<fmt:formatDate value="${forDesp.dtCadastro.time }" pattern="dd/MM/yyyy"/>">
			</td>
