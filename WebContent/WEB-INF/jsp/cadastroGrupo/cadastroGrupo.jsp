...
<script type='text/javascript' src='/safetycar/dwr/interface/cadastroGrupoAjaxDwr.js'></script>
...
<script type=text/javascript>
	...
	function frmSubmit() {
	  ...
	  cadastroGrupoAjaxDwr.addGrupo(nomeGrupo, dataCadastro, paginas, {
...
<div align="center">
	<font size="5" face="Times, serif" color="black"><b><i>Cadastro Grupo</i></b></font>	
</div>


<form action="adicionaGrupo" method="post">
				...
				<tr>
					...
					<td>			
						<input type="text" style="width:200px; height: 24px;" id="dataCadastro" name="dataCadastro" onblur="validaData(this)" onKeyUp="bloqueiaData(this);return mascara(this, '##/##/####', event);"
							maxlength="10" value="<fmt:formatDate value="${grupo.dataCadastro.time}" pattern="dd/MM/yyyy"/>" />			
					</td>		
				</tr>
			</table>
		</td>		
