...
<script type='text/javascript' src='/safetycar/dwr/interface/cadastroVeiculosAjaxDwr.js'></script>
...
<script language="JavaScript" type="text/JavaScript">
	function direcionaTelaPesquisa(){
		...
		window.location="pesquisaFornecedor" + parametros;
	}
	...
	function adicionar(){
		...
		var dataEntrada = dwr.util.getValue("dataEntrada");
	 	...
	 	cadastroVeiculosAjaxDwr.addVeiculo(veiculo, veiculosOpcionais,compraVeiculo,dataEntrada, valorCompra, {
			callback : function(retorno) {
				...
				if(retorno[0] == 'ERRO'){
					...
					document.getElementById("infDocNome").value ="";
					document.getElementById("infDocEndereco").value ="";
					//campo hidden com o id do fornecedor
					...
					combo = document.getElementById("combustivel");
					for ( i =0; i < combo.length; i++){
						combo[i].selected = combo[i].value == 'Selecione' ? true : false;
	                }
					...
					document.getElementById('nao').checked=true;
              		...
              		/* Reseta checkbox */
					document.getElementById("opCompleto").checked=0;
					document.getElementById("opArQuente").checked=0;
					document.getElementById("opFarolXenon").checked=0;
					document.getElementById("opBancoRegAltura").checked=0;
					document.getElementById("opGps").checked=0;
					document.getElementById("opLimpTraseiro").checked=0;
					document.getElementById("opTravaEletrica").checked=0;
					document.getElementById("opRadio").checked=0;
					document.getElementById("opCapotaMaritima").checked=0;
					document.getElementById("opRadioTocaFita").checked=0;
					document.getElementById("opCdMp3").checked=0;
					document.getElementById("opCompBordo").checked=0;
					document.getElementById("opRetroFotocromico").checked=0;
					document.getElementById("opRetrovEletrico").checked=0;
					document.getElementById("opRodLigaLeve").checked=0;
					document.getElementById("opSensorEstacionamento").checked=0;
					document.getElementById("opDVD").checked=0;
					document.getElementById("opTetoSolar").checked=0;
					document.getElementById("opDesembTraseito").checked=0;
					document.getElementById("opTracao4x4").checked=0;
					document.getElementById("opAirBag").checked=0;
					document.getElementById("opVolRegAltura").checked=0;
					document.getElementById("opABS").checked=0;
					document.getElementById("opAlarme").checked=0;
					document.getElementById("opDirecaoHidraulica").checked=0;
					document.getElementById("opBancoCouro").checked=0;
					document.getElementById("opArCondicionado").checked=0;
					document.getElementById("opVidroEletrico").checked=0;
					document.getElementById("opChaveReserva").checked=0;
					document.getElementById("opManual").checked=0;
              		
					/* Hidden */
					$('#btnSalvar').hide();
					$('#dadosFornecedor').hide();
...
<div align="center">
	<font size="5" face="Times, serif" color="black"><b><i>Cadastro de Ve&iacute;culos</i></b></font>	
</div>
			...
			<tr>
				...
				<td>
					...
					<c:if test="${veiculo.renavan > 0}">
						<input id="renavan" name="renavan" type="text" style="width:200px; height: 24px;" maxlength="9" onKeyUp="javascript:somenteNumero(this);" value="${veiculo.renavan }">
					</c:if>			
				</td>
				<td>
