...
<script type='text/javascript' src='/safetycar/dwr/interface/cadastroVendaVeiculoAjaxDwr.js'></script>
...
<script language="JavaScript" type="text/JavaScript">
	function direcionaTelaPesquisa(){
		...
		window.location="vendaVeiculoPesquisaCliente" + parametros;
	}
	...
	function adicionar(){		
		...
		cadastroVendaVeiculoAjaxDwr.addVendaVeiculo(idVeiculo, idCliente, valorVenda, vendedor, dataVenda, {
