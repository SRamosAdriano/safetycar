...
<form id="vlComissaoEVenda" name="vlComissaoEVenda" method="post">
...
<tr>
	<td colspan="4" align="right">
		<a href="#" onClick="document.vlComissaoEVenda.submit();">
	...
	<td colspan="4"> 
		<t:paginacao id="tabela_AltCF" lista="${itensRelatorio}" semPaginacao="false">
			...
			<jsp:attribute name="linha">	
				...
				<td align="center">
					<a href="lancamentoVlComissaoEVendaVeiculoSelecionadoVeiculo?idVeiculo=${item.id}">
			...
			<jsp:attribute name="link">
				javascript: paginar('vlComissaoEVenda', '${tabela}', ${pagina});
			</jsp:attribute>
		</t:paginacao>
	</td>
</tr>
