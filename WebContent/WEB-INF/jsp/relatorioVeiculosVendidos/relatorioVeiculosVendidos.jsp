...
<div align="center">
	<font size="5" face="Times, serif" color="black"><b><i>Relat&oacute;rio Veiculos Vendidos</i></b></font>	
</div>

<br/>

<div align="center">
	<font size="4" face="Times, serif" color="black"><i>Pesquisa Veiculos Vendidos</i></font>
</div>
...
<table style="width: 905px" border="0" align="center">
	<tr>
		<td align="right">
			<a href="#" onClick="abrirNovaJanela('relVeiculosVendidosImpressao?pesqPeriodoDe=${pesqPeriodoDe}&pesqPeriodoAte=${pesqPeriodoAte}&pesqVendedor=${pesqVendedor}&pesqConsignado=${pesqConsignado}','_blank', 'height=760, width=980, top=40, left=25, scrollbars=yes, resizable=no');">
...
<t:paginacao id="tabela_AltCF" lista="${itensRelatorio}" semPaginacao="false">
	<jsp:attribute name="cabecalho">
		...
		<th nowrap><b>Nome Cliente</b></th>			
		<th nowrap><b>Nome Vendedor</b></th>
		<th nowrap><b>Consignado</b></th>
		<th nowrap><b>Data Venda</b></th>
		<th nowrap><b>Valor Venda</b></th>			
	</jsp:attribute>	
	<jsp:attribute name="linha">				
		...
		<td align="center">
			<c:if test="${item.consignado eq true}">
				Sim
			</c:if>
			<c:if test="${item.consignado eq false}">
				Não
			</c:if>
		</td>			
