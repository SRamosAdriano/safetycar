...
public class CadastroVeiculosAjaxDwr {
	
	private static Logger LOG = Logger.getLogger(CadastroVeiculosAjaxDwr.class.getName());

	public List<String> addVeiculo(Veiculos veiculo, VeiculosOpcionais veiculosOpcionais, CompraVeiculo compraVeiculo, String dataEntrada, String valorCompra){
		...
		if(!retorno.get(0).equals("ERRO")){
			...
			if(dao.existeVeiculoAtivo(veiculo.getPlaca())){
				retorno.add(0, "ERRO");
			...
			/*Adiciona*/
			dao.adicionaVeiculo(veiculo, veiculosOpcionais, compraVeiculo);					
