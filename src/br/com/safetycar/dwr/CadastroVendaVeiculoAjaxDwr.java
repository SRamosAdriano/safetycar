...
public class CadastroVendaVeiculoAjaxDwr {
	
	private static Logger LOG = Logger.getLogger(CadastroVendaVeiculoAjaxDwr.class.getName());
	
	public List<String> addVendaVeiculo(Long idVeiculo, Long idCliente, String valorVenda, String vendedor, String dataVenda){		
		...
		if(!retorno.get(0).equals("ERRO")){
			...
			/*Adiciona*/			
			dao.adicionaVendaVeiculo(veiculo, vendaVeiculo);			
