...
/**
 * Contém a lógica para se fazer paginação.
 * Pode ser usado para paginar automaticamente com o método
 * <code>paginar()</code> ou calcular o intervalo de registros
 * para uma dada página com <code>getPrimeiroIndice()</code> e
...
public class Paginador {
    ...
    public int getIndicePrimeiro(int numeroPagina, int total) {
    	// Redundante pois esse método pode ser chamado de fora
    ...
    /**
     * Obtém o número de total dos objetos sendo paginados.
     * 
     * @param filtros Filtros a serem usados.
     * @return Número total de objetos sendo paginados.
     */
     ...
     * 
     * @param indicePrimeiro Índice do primeiro item da página.
     * @param indiceUltimo Índice do último item da página.
     * @param filtros Filtros a serem usados.
